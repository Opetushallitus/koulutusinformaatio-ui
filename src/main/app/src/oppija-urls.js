...
const production = {
    ...
    "konfo-backend.search.koulutukset" : "/konfo-backend/search/koulutusmoduulit",
...
const development = {
    ...
    "konfo-backend.search.koulutukset" : "http://localhost:" + process.env.REACT_APP_BACKEND_PORT + "/konfo-backend/search/koulutusmoduulit",

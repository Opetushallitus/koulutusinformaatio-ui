class Koulutukset {
  static createKoulutuksetSearchResult(count) {
    ...
    for (var i = 0; i < count; i++) {
      koulutukset.push({
        ...
        haettavissa: null,
        nimi: {
          kieli_fi: 'Koulutus fi ' + i,
          kieli_sv: 'Koulutus sv ' + i,
          kieli_en: 'Koulutus en ' + i,
        },
  ...
  static createKoulutusSearchResult(oid) {
    ...
    res.result = {
      ...
      searchData: {
        nimi: {
          kieli_fi: 'Koulutus fi',
          kieli_sv: 'Koulutus sv',
          kieli_en: 'Koulutus en',
        },
        tyyppi: 'kk',
      },
      kuvausKomo: {},
...
class Oppilaitokset {
  static createOppilaitoksetSearchResult(count) {
    ...
    for (var i = 0; i < count; i++) {
      oppilaitokset.push({
        nimi: {
          kieli_fi: 'Oppilaitos fi',
          kieli_sv: 'Oppilaitos sv',
          kieli_en: 'Oppilaitos en',
        },
        tyyppi: 'kk',

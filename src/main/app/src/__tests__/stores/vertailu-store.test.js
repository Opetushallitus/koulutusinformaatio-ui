...
describe('VertailuStore.vertailuList', () => {
    it('koulutus array for toggleKoulutus true', () => {
        ...
        expect(vertailuStore.vertailuList[0]).toEqual({oid: "1", nimi: "Koulutus1", link: "/koulutus/1"})
    });
    ...
    it('oppilaitos array for toggleKoulutus false', () => {
        ...
        expect(vertailuStore.vertailuList[0]).toEqual({oid: "2", nimi: "Oppilaitos4", link: "/oppilaitos/2"})
    });
});
...
describe('VertailuStore.selectItem', () => {
    it('should select item with given oid', () => {
        const vertailuStore = new VertailuStore(koulutusSelected, getKoulutusPromise);

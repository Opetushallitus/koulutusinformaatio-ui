...
class Ammatillinen extends Component {
  ...
  getOsaamisalaKuvaus() {
    ...
    this.props.restStore.getKoulutusKuvaus(
      this.props.koulutusUri,
      'true',
      (k) => {
        this.setState({
          kuvaus: k,
  ...
  getOppilaitosInfo() {
    ...
    this.props.restStore.getOppilaitos(
      this.props.organisaatio.oid,
      'true',
      (k) => {
        this.setState({
          oppilaitos: k,
  ...
  parseAdditionalInfoBoxFields() {
    //placeholder until real data is available from backend
    const fields = [];
    ...
    return (
      <React.Fragment>
        <div className="col-12 col-md-12 col-lg-12 col-xl-12">
            ...
            <div className="hakukohde-info-box">
              ...
              <div className="hakukohde-info-button-wrapper">
                <a
                  role="button"
                  aria-label="Etsi"
                  className="toteutus-hakukohteet-button"
                  href=""
                >
                  Näytä hakukohteet
                </a>
          ...
          {kuvaus && <ToteutusDescriptionBox content={l.localize(kuvaus)} />}

          {osaamisalat && <OsaamisalaInfoBox fields={osaamisalat} />}
          <ToteutusAdditionalInfoBox
            fields={this.parseAdditionalInfoBoxFields()}
          />

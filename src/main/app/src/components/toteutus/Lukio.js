...
class Lukio extends Component {
  ...
  parseInfoBoxFieldsLeft() {
    ...
    const aloitusPvm = new Date(
      Number(this.props.koulutus.koulutuksenAlkamisPvms[0])
    );
    fields.push([
      t('koulutus.alkaa'),
      aloitusPvm.getDate() +
    ...
    fields.push([
      ...
      l.localize(this.props.koulutus.opetuskielis[0]),
    ]);

    const opintojenLaajuusarvo = l.localize(
      this.props.koulutus.opintojenLaajuusarvo,
      '-'
    );
    const opintojenLaajuusyksikko = l.localize(
      this.props.koulutus.opintojenLaajuusyksikko
    );
    fields.push([
      t('koulutus.laajuus'),
    ...
    const suunniteltuKestoTyyppi = l.localize(
      this.props.koulutus.suunniteltuKestoTyyppi
    );
    fields.push([
      t('koulutus.kesto'),
    ...
    fields.push([
      ...
      this.props.koulutus.opetusmuodos.map((t) => l.localize(t) + ' '),
    ]);
    fields.push([
      t('koulutus.pohjakoulutus'),
      l.localize(this.props.koulutus.pohjakoulutusvaatimus),
    ]);
  ...
  render() {
    const { t } = this.props;
    const sisalto = l.localize(
      this.props.koulutus.kuvausKomo.KOULUTUKSEN_RAKENNE,
      undefined
    );
    const erikoistumisalat = l.localize(
        ...
        <div className="col-12 col-md-12 col-lg-8 col-xl-9 left-column">
          ...
          {sisalto && (
            <SlideDropdown
              toteutus={true}
              content={sisalto}
              title={t('koulutus.sisältö')}
            />
          )}
          {erikoistumisalat && (
            <SlideDropdown
              toteutus={true}
              content={erikoistumisalat}
              title={t('koulutus.pääaineet')}
            />
          )}
        </div>
        <ToteutusSidebar

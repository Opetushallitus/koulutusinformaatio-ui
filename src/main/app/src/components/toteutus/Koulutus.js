...
class Koulutus extends Component {
  ...
  chooseKoulutus() {
    const koulutusUri = this.props.location.state
      ? this.props.location.state.koulutusUri
        ? this.props.location.state.koulutusUri
        : undefined
      : undefined;
    ...
    return (
      <React.Fragment>
        <div className="container" id="toteutus-container">
          <div className="row info-page toteutus">{selectedKoulutus}</div>
        </div>
        <Hakunavigaatio />
      </React.Fragment>
    );

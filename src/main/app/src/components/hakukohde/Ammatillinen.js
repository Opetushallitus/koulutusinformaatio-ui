...
class Ammatillinen extends Component {
  ...
  parseInfoBoxFieldsLeft() {
    ...
    const pohjakoulutusvaatimus = this.props.hakukohde.pohjakoulutusvaatimus.map(
      (o) => l.localize(o.nimi)
    );
    fields.push(['Pohjakoulutusvaatimus', pohjakoulutusvaatimus]);
    fields.push([
      'Alkamiskausi',
      l.localize(this.props.hakukohde.alkamiskausi),
    ]);
    ...
    return (
      <React.Fragment>
        <div className="col-12 col-md-12 col-lg-8 col-xl-9 left-column">
          <HakukohdeHeader
            komoOid={this.props.hakukohde.oid}
            nimi={l.localize(this.props.hakukohde.nimi)}
            organisaatio={l.localize(this.props.hakukohde.organisaatio.nimi)}
          />
          <HakukohdeInfoBox
            nimi={l.localize(this.props.hakukohde.nimi)}
            fields={this.parseInfoBoxFieldsTwoSided()}
          />
          <SlideDropdown
            toteutus={true}
            content={'Valintaperusteiden kuvaus'}
            title="Valintaperusteiden kuvaus"
          />
          <SlideDropdown
            valintakokeet={true}
            valintakokeetlist={this.props.hakukohde.valintakokeet}
            title="Valintakokeet"
          />
          <SlideDropdown
            toteutus={true}
            content={'Tarvittavat liitteet'}
            title="Tarvittavat liitteet"
          />
          <SlideDropdown
            toteutus={true}
            content={'Osaamistausta'}
            title="Osaamistausta"
          />
          <SlideDropdown
            toteutus={true}
            content={'Tietoa valintatavasta'}
            title="Tietoa valintatavasta"
          />
          <SlideDropdown
            toteutus={true}
            content={'Kielitaitovaatimukset'}
            title="Kielitaitovaatimukset"
          />
          <SlideDropdown
            toteutus={true}
            content={'Sora-kuvaus'}
        ...
        <HakukohdeSidebar
          organisaatio={this.props.hakukohde.organisaatio}

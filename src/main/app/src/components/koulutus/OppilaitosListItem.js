...
class OppilaitosListItem extends Component {
  ...
  render() {
    ...
    const link =
      ...
      '&lng=' +
      l.getLanguage();
    const koulutusUri = this.props.koulutusUri
      ...
      <div className="row justify-content-end">
        <div className="col-11 item-box">
          <div className="text d-flex justify-content-between">
            <div>
              <Link
                to={{ pathname: link, state: { koulutusUri: koulutusUri } }}
                className={'hakutulosbox-link oppilaitos-list-item-link'}
              >
                {l.localize(
                  oppilaitos.organisaatio.nimi,
                  this.props.t('koulutus.tuntematon')
                )}
              </Link>
              <p className="oppilaitos-list-item-tutkintonimikkeet">
                Tutkintonimikkeet tähän
              </p>

...
class OppilaitosArvostelut extends Component {
  ...
  setRating() {
    const totalRating =
      ...
      this.props.ratingStars.reduce((rating, value) => rating + value.star, 0);
    return totalRating;
  }
        ...
        {(matches) =>
          matches ? (
            <div
              ...
              id="oppilaitos-arvostelut"
            >
              <div className="rating d-flex justify-content-center">
                {ratingStars.map((rating, i) =>
                  rating.star === 1 ? (
                    <span className="icon-ic_star" key={i} />
                  ) : rating.star === 0 ? (
                    <span className="icon-ic_star_border" key={i} />
                  ) : (
            ...
            <div className="col-12">
              <p>
                ...
                {`${totalRating} \\ 88 ihmistä suositellut`}
              </p>
            </div>
          )
        }

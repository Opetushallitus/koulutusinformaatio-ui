      ...
      <React.Fragment>
        <div className="hakupalkki-search">
          <div className="search-wrapper">
            <input
              id="regular-input"
              className="search-wrapper-input search-wrapper-item"
              aia-label={t('haku.kehoite')}
              type="search"
              ...
              onKeyPress={(e) => {
                if (
                  e.key === 'Enter' &&
                  this.props.hakuehtoStore.keyword.length > 2
                ) {
                  this.handleSubmit(e);
                }
              }}
            ...
            <Link
              ...
              className="search-button search-wrapper-item"
              onClick={() => {
                this.closeRajain();
              }}
            >
